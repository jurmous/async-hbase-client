...
public abstract class AbstractRpcClient {
  ...
  public AbstractRpcClient(Configuration conf, String clusterId, SocketAddress localAddr) {
    ...
    this.fallbackAllowed = conf.getBoolean(RpcClient.IPC_CLIENT_FALLBACK_TO_SIMPLE_AUTH_ALLOWED_KEY,
   ...
   */
  Message callBlockingMethod(Descriptors.MethodDescriptor md, AsyncPayloadCarryingRpcController pcrc,
   ...
   */
  protected abstract Pair<Message, CellScanner> call(AsyncPayloadCarryingRpcController pcrc,
